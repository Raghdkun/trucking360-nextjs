        ...
        <div className="container mx-auto px-6 py-3">
          <div className="flex justify-between items-center">
            ...
            <Link href="/" id="logo" className="text-2xl font-bold text-primary">
              <Image src="/images/logo22.png" alt="Trucking 360 Logo" width={120} height={32} className="h-8 w-auto" />
            </Link>
            ...
            <nav id="menu" className="hidden lg:block">
              <ul className="flex flex-row items-center space-x-6">
                ...
                <li>
                  <Link href="/booking" className="block px-4 py-2 text-center text-white bg-primary border border-primary hover:bg-white hover:text-secondary rounded transition-colors duration-300 font-bold">
                    Book a Meeting
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard360" className="block px-4 py-2 text-center text-white bg-secondary border border-secondary hover:bg-white hover:text-secondary rounded transition-colors duration-300 font-bold">
                    Dashboard360
                  </Link>
                </li>
              </ul>
