...
const Footer = () => {
  ...
  const description =
    ...
    "Trucking 360 is your dedicated partner for achieving Fantastic+ results in the Amazon Freight Partner (AFP) program.";
  const location =
    footerData?.location || "620 E. Broad St. Suite U Columbus, OH 43215";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm md:text-base flex items-center">
              ...
              <a
                href={`mailto:${email}`}
                className="text-white hover:text-secondary transition-colors duration-300 email overflow-hidden text-ellipsis whitespace-nowrap block"
              >
                {email}
              </a>
            </p>
